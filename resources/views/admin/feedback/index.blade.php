                            ...
                            @foreach ($feedback as $item)
                                <tr>
                                    ...
                                    <td>                                      
                                        ...
                                        @endcan                                        
                                        @can('feedback_delete')
                                        <a href="javascript:void(0)"  onclick="deleteData('feedback','{{$item->id}}');"  title="Delete Feedback" class="btn-icon text-danger"><i class="fas fa-trash-alt text-danger"></i></a>
                                        @endcan
                                    </td>
                                    @endif
                                </tr>
