...
<section class="section">
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-lg-8"><h2 class="section-title"> {{__('Edit language')}}</h2></div>
        </div>
       @if ($errors->any())
        ...
        <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                    <form method="post" action="{{url('language/'.$language->id)}}" enctype="multipart/form-data" >
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group center">
                                    ...
                                    <div id="image-preview" class="image-preview" style="background-image: url({{url('images/upload/'.$language->image)}})">
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly  name="name" placeholder="{{__('Language Name')}}" value="{{$language->name}}" class="form-control @error('name')? is-invalid @enderror">
                                    @error('name')
                                        <div class="invalid-feedback">{{$message}}</div>
                                    @endif
                                </div>
