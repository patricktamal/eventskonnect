...
<section class="section">
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-lg-8"><h2 class="section-title"> {{__('Add language')}}</h2></div>
        </div>
       @if ($errors->any())
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" placeholder="{{__('Language Name')}}" value="{{old('name')}}" class="form-control @error('name')? is-invalid @enderror">
                                    @error('name')
                                        <div class="invalid-feedback">{{$message}}</div>
                                    @endif
                                </div>
