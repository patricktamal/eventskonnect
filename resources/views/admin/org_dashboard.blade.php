              ...
              <div class="card-stats">
                <div class="card-stats-title">{{__('Order Statistics')}} -
                  <div class="dropdown d-inline">
                    <a class="font-weight-600 dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)" id="orders-month">{{__('All')}}</a>
                                ...
                                <table class="table home-tbl" id="">                                    
                                    <tbody>
                                        @foreach ($events as $item)
                                            <tr>                                   
                                                <td> <img class="table-img" src="{{url('images/upload/'.$item->image)}}"> </td>
                                                ...
                                                <td> 
                                                    ...
                                                    <span class="tbl-info">{{$item->avaliable}} {{__('Pcs left')}}</span>
                                                </td>                                                                                                                    
                                                <td> 
                                                    <button class="btn-icon btn block"><i class="far fa-calendar-alt"></i></button>
                                                    <span class="tbl-info">{{$item->start_time->format('Y-m-d')}}</span>
                                                </td>   
                                            </tr>
                                        @endforeach                           
                                    </tbody>
                        ...
                        <div class="row mb-4">
                          ...
                          <div class="col-9 event-right">
                            ...
                            <div class="progress mb-3" data-height="5">
                              <div class="progress-bar" role="progressbar" data-width="{{$item->average}}%" aria-valuenow="{{$item->average}}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </div>
                        </div>
                        @endforeach
